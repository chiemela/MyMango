...
public class WhiteBoxTestingExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_box_testing_exercise);
        ...
        submitButton.setOnClickListener(v -> {
            ...
            // This would depend on how you're storing the user's selected answers
